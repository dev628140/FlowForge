...
const TaskSchema = z.object({
    ...
    // We don't need other fields for subtasks in this context
...
const breakdownerPrompt = ai.definePrompt({
    ...
    Based on the latest user message and the entire conversation, generate a conversational response and an updated list of subtasks.
    `,
});
