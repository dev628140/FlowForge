...
// Schemas for Chat Title Generation
...
export const GenerateChatTitleInputSchema = z.object({
  history: z.array(ChatMessageSchema).describe("The conversation history to summarize into a title."),
});
...
export const GenerateChatTitleOutputSchema = z.object({
  title: z.string().describe('A short, concise title (4-5 words max) that summarizes the conversation.'),
});
