...
import { Check, Zap, Trash2, Pencil, ArrowUp, ArrowDown, Wand2, ChevronDown, CornerDownRight } from 'lucide-react';
        ...
        <div className={cn("flex items-center group p-2 rounded-md hover:bg-muted/50 transition-colors", isSubtask && "pl-6")}>
            ...
            <div className="flex items-center opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                {hasSubtasks && (
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Button variant="ghost" size="icon" className="w-8 h-8" aria-label="Toggle subtasks" disabled={task.completed} onClick={() => setIsSubtasksOpen(!isSubtasksOpen)}>
                                <ChevronDown className={cn("h-4 w-4 transition-transform duration-200", isSubtasksOpen && "-rotate-180")} />
                            </Button>
                        </TooltipTrigger>
                        <TooltipContent>
                            <p>View Subtasks</p>
